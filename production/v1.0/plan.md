...
## Actions Executed
- Expand base stubs and complete node implementations
- Add WebInputNode with multi-instance support
- Add LM Studio LLM node connection
- Add Docker multi-stage build and docker-compose.yml
- Add live view of node contents via API
- Add MCP protocol server for AI interaction
- Integrate Stack, FIFO Queue, LIFO Queue, Clock nodes
- Update UI palette, node types, docs, groups
- Add unit tests for new nodes
- Create production docs and guides
